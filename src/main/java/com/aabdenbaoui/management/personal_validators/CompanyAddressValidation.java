...
import com.aabdenbaoui.management.entity.company.CompanyAddress;
import com.aabdenbaoui.management.entity.enums.State;
@Component
public class CompanyAddressValidation implements ConstraintValidator<CompanyAddressConstraint, Company> {
    
	
	
	@Override
	public boolean isValid(Company company, ConstraintValidatorContext context) {
	    CompanyAddress address = company.getCompanyAddress();
